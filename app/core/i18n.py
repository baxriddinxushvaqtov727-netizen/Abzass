...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "uz_latin": {
        ...
        "menu.leaderboard": "🏆 Umumiy reyting",
        "menu.rules": "📘 Tanlov nizomi",
        "menu.books": "📚 Tanlov kitoblari",
        "menu.question": "❓ Savol yuborish",
        "profile_prompt": "Ro'yxatdan o'tishni davom ettirish uchun ism, familiya, otasining ismi, viloyat va tumanni kiriting.",
        ...
        "results_test_rank": "Test o'rni: {rank}",
        "results_referral_rank": "Referral o'rni: {rank}",
        "results_test_leader": "Test lideri: {name} - {score} ball",
        "results_referral_leader": "Referral lideri: {name} - {score} ball",
        "leaderboard_title": "Umumiy reyting",
        "leaderboard_referral_title": "Referral reytingi",
        "leaderboard_tests_title": "Testlar reytingi",
        "leaderboard_empty": "Hali reyting uchun ma'lumot yo'q.",
        "leaderboard_no_test_results": "Bu test bo'yicha hali natija yo'q.",
        "leaderboard_referral_line": "{rank}. {name} - {score} ball | {count} ta referral",
        "leaderboard_test_line": "{rank}. {name} - {score}/{total} ball",
    ...
    "uz_cyrillic": {
        ...
        "menu.leaderboard": "🏆 Умумий рейтинг",
        "menu.rules": "📘 Танлов низоми",
        "menu.books": "📚 Танлов китоблари",
        "menu.question": "❓ Савол юбориш",
        "profile_prompt": "Рўйхатдан ўтишни давом эттириш учун исм, фамилия, отасининг исми, вилоят ва туманни киритинг.",
        ...
        "results_test_rank": "Тест ўрни: {rank}",
        "results_referral_rank": "Referral ўрни: {rank}",
        "results_test_leader": "Тест лидери: {name} - {score} балл",
        "results_referral_leader": "Referral лидери: {name} - {score} балл",
        "leaderboard_title": "Умумий рейтинг",
        "leaderboard_referral_title": "Referral рейтинги",
        "leaderboard_tests_title": "Тестлар рейтинги",
        "leaderboard_empty": "Ҳали рейтинг учун маълумот йўқ.",
        "leaderboard_no_test_results": "Бу тест бўйича ҳали натижа йўқ.",
        "leaderboard_referral_line": "{rank}. {name} - {score} балл | {count} та referral",
        "leaderboard_test_line": "{rank}. {name} - {score}/{total} балл",
    ...
    "ru": {
        ...
        "menu.leaderboard": "🏆 Общий рейтинг",
        "menu.rules": "📘 Положение конкурса",
        "menu.books": "📚 Книги конкурса",
        "menu.question": "❓ Отправить вопрос",
        "profile_prompt": "Чтобы продолжить регистрацию, заполните имя, фамилию, отчество, область и район.",
        ...
        "results_test_rank": "Место в тестах: {rank}",
        "results_referral_rank": "Место по referral: {rank}",
        "results_test_leader": "Лидер тестов: {name} - {score} баллов",
        "results_referral_leader": "Лидер referral: {name} - {score} баллов",
        "leaderboard_title": "Общий рейтинг",
        "leaderboard_referral_title": "Рейтинг по referral",
        "leaderboard_tests_title": "Рейтинг по тестам",
        "leaderboard_empty": "Пока нет данных для рейтинга.",
        "leaderboard_no_test_results": "По этому тесту пока нет результатов.",
        "leaderboard_referral_line": "{rank}. {name} - {score} баллов | {count} referral",
        "leaderboard_test_line": "{rank}. {name} - {score}/{total} баллов",
